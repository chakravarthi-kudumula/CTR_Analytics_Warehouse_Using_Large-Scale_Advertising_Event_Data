...
select
    ...
    promotion_min_roc_auc_improvement,
    promotion_min_pr_auc_improvement,
    promotion_min_lift_improvement,
    active_validation_roc_auc,
    active_validation_pr_auc,
    active_validation_lift_at_10pct,
    promotion_roc_auc_gap,
    promotion_pr_auc_gap,
    promotion_lift_gap,
    promotion_status,
